...
func FetchCodexModels(
	...
	if baseURL == "" || accessToken == "" || accountID == "" || clientVersion == "" {
		return 0, nil, fmt.Errorf("codex channel discovery requires base URL, access_token, account_id and client_version")
	}
