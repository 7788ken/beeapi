...
func StartCodexCredentialAutoRefreshTask() error {
	var startErr error
	codexCredentialRefreshOnce.Do(func() {
		...
		startErr = backgroundtask.Start("codex-credential-auto-refresh", func(ctx context.Context) {
			...
			backgroundtask.RunPeriodic(ctx, codexCredentialRefreshTickInterval, true, func() {
