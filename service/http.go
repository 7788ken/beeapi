...
// ShouldCopyUpstreamHeader preserves this instance's request ID while recording
// the ID returned by an upstream new-api instance for later log correlation.
