...
func GetAsyncRefundReconciliation(c *gin.Context) {
	...
	if endTime-startTime > 31*24*60*60 {
		common.ApiErrorMsg(c, "只读退款对账窗口不能超过31天")
		return
	}
	limit, err := strconv.Atoi(c.DefaultQuery("limit", "200"))
	if err != nil || limit <= 0 || limit > 500 {
		common.ApiErrorMsg(c, "limit 必须在1到500之间")
		return
	}
	report, err := model.BuildAsyncRefundReconciliation(startTime, endTime, limit)
	if err != nil {
