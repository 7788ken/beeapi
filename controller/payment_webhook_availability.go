...
func isCryptomusTopUpEnabled() bool {
	...
	return strings.TrimSpace(setting.CryptomusMerchantID) != "" &&
		strings.TrimSpace(setting.CryptomusPaymentApiKey) != ""
}

func isCryptomusWebhookEnabled() bool {
...
func isAgouTopUpEnabled() bool {
	...
	return strings.TrimSpace(setting.AgouBaseURL) != "" &&
		strings.TrimSpace(setting.AgouAppId) != "" &&
		strings.TrimSpace(setting.AgouAppSecret) != "" &&
		strings.TrimSpace(setting.AgouGroupCode) != ""
}

func isAgouWebhookEnabled() bool {
	return isAgouTopUpEnabled()
}
