...
> 与上游逐文件比对：上游 1990 文件 / 本 fork 2424 文件，**fork 独有 1801 个**（前端 1440、后端约 320）。
> 提交构成：424 个 commit，其中 fix 158 / feat 135 / refactor 19 / perf 5。
> 本文档收录 **36 项自研功能与修复**，每条含：介绍 / 原理 / 实现方案。
