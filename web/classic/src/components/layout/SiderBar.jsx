...
const routerMap = {
  ...
  group_square: '/console/group-square',
  token: '/console/token',
...
const SiderBar = ({ onNavigate = () => {} }) => {
  ...
  const workspaceItems = useMemo(() => {
    ...
    // 分组广场：本地补丁追加，不受后台模块开关控制；插入到令牌管理之前
    const tokenIdx = filteredItems.findIndex((it) => it.itemKey === 'token');
    const insertIdx = tokenIdx >= 0 ? tokenIdx : 0;
    filteredItems.splice(insertIdx, 0, {
      text: t('分组广场'),
      itemKey: 'group_square',
      to: '/group-square',
    });
