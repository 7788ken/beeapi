...
import PromoteRootModal from './modals/PromoteRootModal';
import DemoteRootModal from './modals/DemoteRootModal';
...
const UsersTable = (usersData) => {
  ...
  const [showDemoteRootModal, setShowDemoteRootModal] = useState(false);
  ...
  const showDemoteRootUserModal = (user) => {
    setModalUser(user);
    setShowDemoteRootModal(true);
  };
  ...
  const handleDemoteRootConfirm = () => {
    manageUser(modalUser.id, 'demote_root', modalUser);
    setShowDemoteRootModal(false);
  };
  ...
  const columns = useMemo(() => {
    return getUsersColumns({
      ...
      showDemoteRootModal: showDemoteRootUserModal,
  ...
  return (
    <>
      ...
      <DemoteRootModal
        visible={showDemoteRootModal}
        onCancel={() => setShowDemoteRootModal(false)}
        onConfirm={handleDemoteRootConfirm}
        user={modalUser}
        t={t}
      />
