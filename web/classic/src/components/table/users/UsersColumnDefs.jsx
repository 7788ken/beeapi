...
const renderOperations = (
  ...
  const canPromoteToRoot = isRoot() && record.role === 10;
  const canDemoteFromRoot =
    getUserIdFromLocalStorage() === 1 && record.role === 100;
      ...
      ? [
          {
            ...
            name: t('降为管理员'),
            type: 'danger',
            onClick: () => showDemoteRootModal(record),
          },
        ]
      : []),
    ...(canPromoteToRoot || canDemoteFromRoot
      ? [{ node: 'divider' }]
      : []),
    {
      node: 'item',
