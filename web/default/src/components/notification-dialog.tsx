...
import { PriceChangeBatchList } from '@/features/price-changes/components'
import type { PriceChangeBatch } from '@/features/price-changes/types'
...
interface NotificationDialogProps {
  ...
  loading: boolean
  onCloseToday: () => void
  priceChangeBatches?: PriceChangeBatch[]
  showPriceChanges?: boolean
  priceChangesLoading?: boolean
  /** Viewer's own group — effective prices are rendered from this perspective */
  priceChangeGroup?: string
}
      ...
      <DialogContent className='max-h-[90vh] sm:max-w-2xl'>
        ...
        >
          <TabsList
            className={cn(
              'grid w-full',
              showPriceChanges ? 'grid-cols-3' : 'grid-cols-2'
            )}
          >
