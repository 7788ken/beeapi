...
import { SubscriptionUsageButton } from '@/features/subscription-usage/components/subscription-usage-button'
    ...
    <>
      ...
      {showNotifications && (
        <NotificationDialog
          ...
          priceChangeBatches={notifications.priceChangeBatches}
          showPriceChanges={notifications.priceChangesEnabled}
          priceChangesLoading={notifications.priceChangesLoading}
          priceChangeGroup={notifications.viewerGroup}
        />
      )}
    </>
  )
