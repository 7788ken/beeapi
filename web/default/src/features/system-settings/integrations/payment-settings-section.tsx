  ...
  return (
    ...
    >
      ...
      >
        ...
        <Form {...form}>
        <TabsContent value='general' className='flex-1 space-y-4 overflow-y-auto pr-2'>
        ...
        <TabsContent value='epay' className='flex-1 space-y-4 overflow-y-auto pr-2'>
          <div className='space-y-4'>
            <div>
        ...
        <TabsContent value='stripe' className='flex-1 space-y-4 overflow-y-auto pr-2'>
          <div className='space-y-4'>
            <div>
        ...
        <TabsContent value='creem' className='flex-1 space-y-4 overflow-y-auto pr-2'>
          <div className='space-y-4'>
            <div>
        ...
        <TabsContent value='waffo' className='flex-1 space-y-4 overflow-y-auto pr-2'>
          <WaffoSettingsSection defaultValues={waffoDefaultValues} />
        </TabsContent>

        <TabsContent value='waffo-pancake' className='flex-1 space-y-4 overflow-y-auto pr-2'>
