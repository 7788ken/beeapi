...
export function PaymentMethodDialog({
  ...
  useEffect(() => {
    if (editData) {
      form.reset({
        ...
        allowed_groups: editData.allowed_groups ?? '',
      })
    } else {
      form.reset({
        name: '',
  ...
  const handleSubmit = (values: PaymentMethodDialogFormValues) => {
    ...
    if (values.allowed_groups && values.allowed_groups.trim() !== '') {
      data.allowed_groups = values.allowed_groups.trim()
    }
    onSave(data)
    form.reset()
    onOpenChange(false)
        ...
        <Form {...form}>
          ...
          >
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('Allowed groups (optional)')}</FormLabel>
                  <FormControl>
                    <Input placeholder={t('e.g., vip;premium')} {...field} />
                  </FormControl>
                  <FormDescription>
                    {t(
