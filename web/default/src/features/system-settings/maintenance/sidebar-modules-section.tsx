...
export function SidebarModulesSection({
  ...
  const sectionMeta: Record<string, { title: string; description: string }> = {
    dashboard: {
      title: t('Dashboard panels'),
      description: t('Admin-only overview cards on the dashboard.'),
    },
    chat: {
      title: t('Chat area'),
  ...
  > = {
    dashboard: {
      performanceOverview: {
        ...
        description: t('Inline KPI strip showing top models on the dashboard.'),
      },
      performanceHealth: {
        title: t('Performance health'),
        description: t(
          'Larger health card with success rate, latency, throughput and top models.'
        ),
      },
    },
    chat: {
