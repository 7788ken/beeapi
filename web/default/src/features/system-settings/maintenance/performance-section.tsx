...
export function PerformanceSection(props: Props) {
  ...
  const metricsEnabled = form.watch('perf_metrics_setting.enabled')
    ...
    >
      ...
      <Form {...form}>
        <form onSubmit={handleSubmit} className='space-y-6'>
          ...
          <div>
            <h4 className='font-medium'>{t('Performance Metrics Collection')}</h4>
            <p className='text-muted-foreground mt-1 text-xs'>
              {t(
                'Collect per-model latency / TTFT / success rate / TPS samples for the model square performance badges and rankings.'
              )}
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 gap-4 md:grid-cols-4'>
            <FormField
              ...
              render={({ field }) => (
                <FormItem className='flex items-center gap-2'>
                  ...
                  <FormLabel>{t('Enable Metrics Collection')}</FormLabel>
                </FormItem>
              )}
            />
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    {t('How often hot buckets are persisted to DB')}
                  </FormDescription>
                </FormItem>
              )}
            />
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('Bucket Granularity')}</FormLabel>
                  <FormControl>
                    <Select
                      value={field.value}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('Retention (days, 0 = keep forever)')}</FormLabel>
                  <FormControl>
                    <Input
                      type='number'
                      {...field}
