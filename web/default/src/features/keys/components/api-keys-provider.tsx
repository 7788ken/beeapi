...
type ApiKeysContextType = {
  ...
  /**
   * Optional pre-filled group name when opening the create drawer.
   * Set by the Group Square page (via `?group=NAME` deep link); consumed once
   * by api-keys-mutate-drawer on its first reset, then cleared.
   */
  presetGroup: string | null
  setPresetGroup: React.Dispatch<React.SetStateAction<string | null>>
}
