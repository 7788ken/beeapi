  ...
  columns.push(
    ...
    createProgressColumn<TaskLog>({ headerLabel: t('Progress') }),
    {
      ...
      cell: function DetailsCell({ row }) {
        ...
        // Exclude Suno (audio) and Midjourney (image) — those platforms reuse
        // the GENERATE action but produce non-video output and don't have a
        // VideoProxy result URL.
        const isVideoPlatform =
          log.platform !== 'suno' && log.platform !== 'mj'

        if (isSuccess && isVideoTask && isVideoPlatform) {
