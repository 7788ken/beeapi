...
export const TYPE_TO_KEY_PROMPT: Record<number, string> = {
  ...
  23: 'Format: TokenHub API key, or AppId|SecretId|SecretKey for native TC3',
...
// 上游分组倍率角标显示窗口（天）。后端 ratio_monitor_setting.badge_days 默认同为 7，
// 但该配置目前未下发到前端，两侧需保持一致。
export const RATIO_BADGE_WINDOW_DAYS = 7
