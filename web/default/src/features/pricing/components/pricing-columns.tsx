...
import { PriceChangeBadge } from '@/features/price-changes/components'
import type { ModelPriceChange } from '@/features/price-changes/types'
...
export interface PricingColumnsOptions {
  ...
  priceChanges?: Map<string, ModelPriceChange>
    ...
    // Model column
    {
      ...
      cell: ({ row }) => {
        ...
        const vendorIcon = model.vendor_icon
          ...
          : null
        const priceChange = priceChanges?.get(model.model_name || '')
