...
const (
	...
	MsgUserPromoteRootRequireAdmin   = "user.promote_root_require_admin"
	MsgUserDemoteRootRequireFounder  = "user.demote_root_require_founder"
	MsgUserDemoteRootCannotSelf      = "user.demote_root_cannot_self"
	MsgUserDemoteRootRequireRoot     = "user.demote_root_require_root"
