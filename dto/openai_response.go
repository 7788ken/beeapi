...
// CacheCreationTokensTotal returns the normalized cache-write count.
// OpenAI reports cache_write_tokens while legacy and converted providers may
// report cached_creation_tokens. Taking the larger value avoids double billing
// when both fields describe the same cache write.
