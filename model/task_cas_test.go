...
func truncateTables(t *testing.T) {
	...
	t.Cleanup(func() {
		...
		DB.Exec("DELETE FROM async_task_refund_records")
		DB.Exec("DELETE FROM users")
		DB.Exec("DELETE FROM tokens")
		DB.Exec("DELETE FROM batch_update_delete_ledgers")
		DB.Exec("DELETE FROM flush_operation_ledgers")
