...
func SetRelayRouter(router *gin.Engine) {
	...
	relayV1Router.Use(middleware.TokenHealthRecord())
	{
		// WebSocket 路由（统一到 Relay）
		wsRouter := relayV1Router.Group("")
		wsRouter.Use(middleware.Distribute())
		wsRouter.Use(middleware.SensitiveCollector())
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.TokenHealthRecord(), middleware.Distribute())
	{
	...
	relayGeminiRouter.Use(middleware.TokenHealthRecord())
	relayGeminiRouter.Use(middleware.Distribute())
	relayGeminiRouter.Use(middleware.SensitiveCollector())
	{
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.TokenHealthRecord(), middleware.Distribute())
	{
